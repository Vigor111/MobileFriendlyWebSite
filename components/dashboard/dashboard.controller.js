(function() {
    ...
    function DashboardController($user, $dialog, $q, $game, $players, $state, $window, CustomerProfileService, $storage, $interval) {
        var vm = this;
        /**
        ...
        function _initialize() {
            if ($storage.getNextUrl()) {
                // console.log('remain on dsasboar');
                // console.log($storage.getNextUrl());
                $storage.setNextUrl('');
